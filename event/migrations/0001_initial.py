# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-03-15 04:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.CharField(blank=True, default='', max_length=256, null=True)),
                ('email', models.CharField(blank=True, default='', max_length=256, null=True)),
                ('social', models.CharField(blank=True, default='', max_length=256, null=True)),
                ('timezone', models.CharField(blank=True, default='', max_length=256, null=True)),
